...
public class MessageGenerator {
    ...
    private final String listenerUrl = "http://localhost:7007/OdysiiDeliveryStation/VirtualWriteMessage";
    ...
    /**
     * @param commandValue : body
     */
    public void doPostRequest(String commandValue){
        String input = ""+messageInfo+""+commandValue+""+endMessageInfo+"";
        try {
